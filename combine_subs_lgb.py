...
# prediction="sub20171010_064828.csv"#script preds
# prediction='sub20170821_221910.csv'#only 2016 data
prediction='lgb_v2.csv'#only lgb
...
for line in ff:
    ...
    for j in range (1,7):
        preds[j-1]=(preds[j-1]*0.3 + float(pre_line_splits[j])*0.7)
