...
properties.hashottuborspa = properties16.hashottuborspa.astype(str)
properties.fireplaceflag = properties16.fireplaceflag.astype(str)
...
train2016 = train2016.merge(properties, how='left', on='parcelid')
train2017 = train2017.merge(properties, how='left', on='parcelid')
...
train.isnull().sum(axis=1).shape


# In[14]:

train.insert(1,'nans',train.isnull().sum(axis=1))
test.insert(1,'nans',test.isnull().sum(axis=1))
train['y'] = logerrors
test['y'] = np.nan
